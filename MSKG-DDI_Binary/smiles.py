...
data = pd.read_csv("./kempnn/ESOL.csv")
data_our = pd.read_csv("./data/smiles.csv")
smiles_for_knowledge_annotation = data_our["smiles"]  # array of smiles
knowledge_annotation_labels = [
    make_crippen_knowledge_attention(s) for s in data_our["smiles"]
